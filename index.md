...
$("display").innerHTML+="<td>"+num+"</td>";
  ...
  td{border:1px black solid;font-size:3em;padding:15px;}iframe{width:100%;height:700px;}</style><br><iframe src="https://phet.colorado.edu/sims/html/plinko-probability/latest/plinko-probability_en.html" ></iframe></body>
